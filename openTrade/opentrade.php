                ...
                <tr>
                    ...
                    <td><select name="selectDistributor" id="selectDistributor">
                            ...
                            if($wpdb->check_connection()){
                                $distributors =  $wpdb->get_results("SELECT `distributor_id`, `distributor_name` FROM `ot_custom_distributor` WHERE `type` = 'Distributor';");
            ...
            if($_POST["selectActionAssignedProducts"] === "add"){
                if(isset($_POST["idAssignedProductAll"])){
                    ...
                    foreach ($idProducts as $id){
                        ...
                        $totalAmountOffer = $totalAmountOffer + $priceUnit;
            ...
            if($_POST["selectActionAssignedProductPostOffer"] == "delete"){
                if(isset($_POST["idAssignedProduct"])){
                    ...
                    foreach ($idProducts as $id){
                        ...
                        $totalAmount = $totalAmount + ($priceUnit * $quantity);
                        $totalAmountOffer = $totalAmountOffer + ($priceOffer * $quantity);
