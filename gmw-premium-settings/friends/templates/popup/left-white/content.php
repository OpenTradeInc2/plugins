<?php 
/**
 * Members Locator "left-white" pop-up window tempalte file . 
 * 
...
<div class="top-buttons-wrapper">		
	...
	<?php gmw_window_toggle( $gmw, $member, false, 'gmw-iw-template-holder', 'dashicons-arrow-right-alt2', 'dashicons-arrow-left-alt2', 'width', '30px', '100%' ); ?>
